...
function editCustomAvailabilities(entryType, teacherID, availibilityID, changeDate, start_time, end_time) {
    // $('#changeCustomAvailabilitiesModal').modal('show');
    if (entryType == 'AVAILABILITIES') {
        $('#edit_custom_date_time_customer_id').val(teacherID);
        $('#edit_custom_date_time_holiday_id').val(availibilityID);
        ...
        $('#edit_break_start_custome_date_time').val('');
        $('#edit_break_end_custome_date_time').val('');
        $('#edit_custom_date_entry_type').val(entryType);
    } else {
        $('#edit_custom_date_time_customer_id').val(teacherID);
        $('#edit_custom_date_time_holiday_id').val(availibilityID);
        $('#edit_custom_date_time_selector').val(changeDate);
        $('#edit_start_custome_date_time').val('');
        $('#edit_end_custome_date_time').val('');
        $('#edit_break_start_custome_date_time').val(start_time);
        $('#edit_break_end_custome_date_time').val(end_time);
        $('#edit_custom_date_entry_type').val(entryType);
    }
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: BaseURLForAdmin + '/coach/changeSpecificDateAvailabilityEdit',
                    data: formData,
                    type: 'POST',
                    cache: false,
                    processData: false,
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: BaseURLForAdmin + '/coach/changeSpecificDateAvailability',
                    data: formData,
                    type: 'POST',
                    cache: false,
                    processData: false,
...
function deleteCustomAvailabilities(entryType, customAvailibilityId) {
    swal({
        title: "Are you sure?",
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    url: BaseURLForAdmin + '/coach/deleteCustomAvailibility',
                    type: 'POST',
                    data: {
                        '_token': csrf_token,
                        'customAvailibilityId': customAvailibilityId,
                        'entryType': entryType
                    },
                    success: function (response) {
                        jsonData = JSON.parse(response);
...
$('#edit_coach_holidays_submit').on('submit', function (event) {
    ...
    $.ajax({
        url: BaseURLForAdmin + '/coach/submitHolidays',
        data: formData,
        type: 'POST',
        cache: false,
        processData: false,
...
$('#edit_coach_availabilities_submit').on('submit', function (event) {
    ...
    var formData = new FormData($(this).closest('form')[0]);
    formData.append('MondayStatus', MondayStatus);
    formData.append('TuesdayStatus', TuesdayStatus);
    formData.append('WednesdayStatus', WednesdayStatus);
    formData.append('ThursdayStatus', ThursdayStatus);
    formData.append('FridayStatus', FridayStatus);
    formData.append('SaturdayStatus', SaturdayStatus);
    formData.append('SundayStatus', SundayStatus);
    // CHANGE STATUS
    formData.append('MondayChangeStatus', MondayChangeStatus);
    formData.append('TuesdayChangeStatus', TuesdayChangeStatus);
    formData.append('WednesdayChangeStatus', WednesdayChangeStatus);
    formData.append('ThursdayChangeStatus', ThursdayChangeStatus);
    formData.append('FridayChangeStatus', FridayChangeStatus);
    formData.append('SaturdayChangeStatus', SaturdayChangeStatus);
    formData.append('SundayChangeStatus', SundayChangeStatus);
    formData.append('_token', csrf_token);

    $.ajax({
        url: BaseURLForAdmin + '/coach/editAvailabilities',
        data: formData,
        type: 'POST',
        cache: false,
        processData: false,
...
$('#edit_customer_submit').on('submit', function (event) {
    ...
    formData.append('companySessionStatus', companySessionStatus);
    formData.append('companyRecurringSessionStatus', companyRecurringSessionStatus);


    formData.append('assignSweetStatus', assignSweetStatus);
    formData.append('assignRecurringSweetStatus', assignRecurringSweetStatus);
    formData.append('is_email_notification_on', UserEmailNotificationStatus);
    formData.append('_token', csrf_token);

    $.ajax({
        url: BaseURLForAdmin + '/customers/editCustomer',
        data: formData,
        type: 'POST',
        cache: false,
        processData: false,
        ...
        success: function (response) {
            ...
            if (jsonData.status == 1) {
                toastr.success("Success!");
                setInterval(function () {
                    window.location.href = BaseURLForAdmin + '/customers/customer_view';
                }, 3000);
            } else {
                toastr.error(jsonData.message);
            }
...
function deleteCustomer(customerId) {
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    url: BaseURLForAdmin + '/customers/delete',
                    type: 'POST',
                    data: {
                        '_token': csrf_token,
...
var cuatomerDatatabele = $('#customer-lists-datatable').DataTable({
    ...
    "ordering": false,
    "ajax": {
        "url": BaseURLForAdmin + '/customers/getAllCustomers',
        "type": "POST",
        data: {_token: csrf_token, 'countryCode': $('#filter-by-country-code-customer-datatable').val()},
...
$('#edit_coach_submit').on('submit', function (event) {
    ...
    $.ajax({
        url: BaseURLForAdmin + '/coach/editCoach',
        data: formData,
        type: 'POST',
        cache: false,
        processData: false,
...
$('#teacher-booking-session-status').on('change', function (event) {
    event.preventDefault();

    var getProfileId = $('#reported-user-id').val();

    var bookingUserStatus;
    if ($('#teacher-booking-session-status').prop("checked") == true) {
        bookingUserStatus = '1';
    } else if ($('#teacher-booking-session-status').prop("checked") == false) {
        bookingUserStatus = '0';
    }

    $.ajax({
        url: BaseURLForAdmin + '/coach/changeBookingStatus',
        data: {"reportedUserID": getProfileId, "bookingUserStatus": bookingUserStatus, "_token": csrf_token},
        type: 'POST',
        cache: false,
        beforeSend: function () {
            swal({
...
$('#change_coach_status_document_status').on('click', function (event) {
    var documentUserID = $('#document-user-id').val();
    var documentStatusString = $('#document-status-string').val();

    var reportedUserStatus;
    if ($('#user-profile-status').prop("checked") == true) {
        reportedUserStatus = '1';
    } else if ($('#user-profile-status').prop("checked") == false) {
        reportedUserStatus = '0';
    }
    ...
    $.ajax({
        ...
        data: {
            ...
            "documentUserStatus": documentStatusString,
...
$('#export-to-student-data-report-to-excel').on('click', function (event) {
    ...
    $('#export-to-pay-scale-report-to-excel').attr("disabled", true);
    $('#export-to-pay-scale-report-to-excel').html('<i class="icon-refresh spinner"></i>&nbsp;&nbsp;Please wait..!');
    window.open(BaseURLForAdmin + '/export/exportStudents/?, _blank');
    $('#export-to-pay-scale-report-to-excel').attr("disabled", false);
    $('#export-to-pay-scale-report-to-excel').html('Export to Excel');
...
$('#teacher-can-booking-trail-session-status').on('change', function (event) {
    event.preventDefault();

    var getProfileId = $('#reported-user-id').val();

    var bookingTrailSessionStatus;
    if ($('#teacher-can-booking-trail-session-status').prop("checked") == true) {
        bookingTrailSessionStatus = '1';
    } else if ($('#teacher-can-booking-trail-session-status').prop("checked") == false) {
        bookingTrailSessionStatus = '0';
    }

    $.ajax({
        url: BaseURLForAdmin + '/coach/changeTrailBookingStatus',
        data: {
...
$('#submit_company_form').on('submit', function (event) {
    ...
    $.ajax({
        url: BaseURLForAdmin + '/companies/addNew',
        data: formData,
        type: 'POST',
        cache: false,
        processData: false,
...
$('#edit_company_form').on('submit', function (event) {
    ...
    $.ajax({
        url: BaseURLForAdmin + '/companies/editCompany',
        data: formData,
        type: 'POST',
        cache: false,
        processData: false,
...
function deleteCompany(companyId) {
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    url: BaseURLForAdmin + '/companies/delete',
                    type: 'POST',
                    data: {
                        '_token': csrf_token,
                        'companyId': companyId
