...
{{--    TODO: Add chech for super-Admin--}}
    ...
    <ul class="navigation navigation-main hidden" id="main-menu-navigation" data-menu="menu-navigation">
        <li class="<?php if(\Illuminate\Support\Facades\Request::segment(2) == 'hear_about_ifal' && \Illuminate\Support\Facades\Request::segment(3) == ''): echo 'active'; endif; ?> nav-item"><a href="<?= url('admin/hear_about_ifal/') ?>"><i class="icon-directions"></i><span class="menu-title" data-i18n="nav.dash.main">Hear About Spokly</span></a>
        </li>
    </ul>

    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class="<?php if(\Illuminate\Support\Facades\Request::segment(2) == 'teacher'): echo 'active'; endif; ?> nav-item"><a href="<?= env('APP_URL').'/teacher' ?>"><i class="icon-user"></i><span class="menu-title" data-i18n="nav.dash.main">Teachers</span></a>
        </li>
    </ul>
    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class=" nav-item"><a href="<?= url('admin/companies') ?>"><i class="icon-docs"></i><span class="menu-title" data-i18n="nav.dash.main">Company</span></a>
            <ul class="menu-content">
                <li class="<?php if(\Illuminate\Support\Facades\Request::segment(2) == 'companies' && \Illuminate\Support\Facades\Request::segment(3) == 'add'): echo 'active'; endif; ?>"><a class="menu-item" href="<?= url('admin/companies/add') ?>" data-i18n="nav.dash.ecommerce">Add New</a></li>
                <li class="<?php if(\Illuminate\Support\Facades\Request::segment(2) == 'companies' && \Illuminate\Support\Facades\Request::segment(3) == ''): echo 'active'; endif; ?>"><a class="menu-item" href="<?= url('admin/companies/') ?>" data-i18n="nav.dash.ecommerce">View All</a></li>
                <li class="<?php if(\Illuminate\Support\Facades\Request::segment(2) == 'companies' && \Illuminate\Support\Facades\Request::segment(3) == 'report'): echo 'active'; endif; ?>"><a class="menu-item" href="<?= url('admin/companies/report') ?>" data-i18n="nav.dash.ecommerce">View Report</a></li>
            </ul>
        </li>
    </ul>
    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class=" nav-item"><a href="<?= url('admin/appointments') ?>"><i class="icon-graph"></i></i><span class="menu-title" data-i18n="nav.dash.main">Reports</span></a>
            <ul class="menu-content" style="margin-left: -15px">
                ...
                <li class="<?php if(\Illuminate\Support\Facades\Request::segment(2) == 'hear_about_ifal' && \Illuminate\Support\Facades\Request::segment(3) == ''): echo 'active'; endif; ?> nav-item"><a href="<?= url('admin/hear_about_ifal/') ?>"><span class="menu-title" data-i18n="nav.dash.main">Hear About Spokly</span></a></li>
